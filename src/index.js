...
const colors = {};
colors['baseText'] = '#e8e8e8';
colors['placeHolderText'] = '#888888';
colors['background'] = '#0f0f0f';
colors['border'] = '#2d2d2d';
colors['borderCanvas'] = '#3d3d3db8';
...
function initUI() {
    ...
    const icons = {
        mindEditor: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg>',
    ...
    menu.addItem('MindEditor', function () { menuItemMainHandler(); }, undefined, false, true, false, icons.mindEditor);
