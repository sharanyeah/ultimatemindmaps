...
function drawRootNode(ctx, mindMap, node) {
    ...
    ctx.shadowBlur = 12 * mindMap.view.scale;
    ctx.shadowOffsetX = 0;
    ctx.shadowOffsetY = 4 * mindMap.view.scale;

    drawRoundedRect(ctx, point.x - node.boundbox.width / 2 * mindMap.view.scale, point.y - node.boundbox.height / 2 * mindMap.view.scale, node.boundbox.width * mindMap.view.scale, node.boundbox.height * mindMap.view.scale, 12 * mindMap.view.scale);
